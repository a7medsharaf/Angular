...
export class SafeBoxsGridComponent implements OnInit {
  ...
  constructor(private SafeBoxService:SafeBoxsService) { }

  ngOnInit(): void {
    console.log('Recived Branch '+this.Branch)
    console.log(this.SafeBoxService.GetBranchSafeBoxes(this.Branch));
    this.SafeBoxes=this.SafeBoxService.GetBranchSafeBoxes(this.Branch);
